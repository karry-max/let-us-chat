package com.yxp.frequencycontrol.service.frequencycontrol;

import com.yxp.frequencycontrol.domain.dto.FrequencyControlDTO;
import com.yxp.frequencycontrol.exception.CommonErrorEnum;
import com.yxp.frequencycontrol.exception.FrequencyControlException;
import com.yxp.frequencycontrol.util.AssertUtil;
...
public abstract class AbstractFrequencyControlService<K extends FrequencyControlDTO> {
     ...
     *
     * @param frequencyControlList 频控列表 包含每一个频率控制的定义以及顺序 比如 k：FixedWindowDTO
     * @param supplier             函数式入参-代表每个频控方法执行的不同的业务逻辑
     * @return 业务方法执行的返回值
