package com.yxp.chat.common.chat.service.impl;
...
import com.yxp.chat.common.chat.dao.*;
import com.yxp.chat.common.chat.domain.dto.MsgReadInfoDTO;
import com.yxp.chat.common.chat.domain.entity.*;
...
import com.yxp.chat.common.chat.domain.vo.response.ChatMemberStatisticResp;
...
import com.yxp.chat.common.chat.service.cache.RoomGroupCache;
import com.yxp.chat.common.chat.service.helper.ChatMemberHelper;
import com.yxp.chat.common.chat.service.strategy.mark.AbstractMsgMarkStrategy;
import com.yxp.chat.common.chat.service.strategy.mark.MsgMarkFactory;
import com.yxp.chat.common.chat.service.strategy.msg.AbstractMsgHandler;
import com.yxp.chat.common.chat.service.strategy.msg.MsgHandlerFactory;
import com.yxp.chat.common.chat.service.strategy.msg.RecallMsgHandler;
...
public class ChatServiceImpl implements ChatService {
    ...
    /**
     * 获取成员分页列表
     * @param memberUidList 会话房间的所有uid
     * @param request       房间id
     * @return
     */
    @Override
    ...
    public void recallMsg(Long uid, ChatMessageBaseReq request) {
        ...
        //校验能不能执行撤回 （1.不是管理员不能撤回 2.不是自己发的不能撤回 3.超过2分钟的不能撤回）
