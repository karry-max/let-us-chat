...
import com.yxp.chat.common.chat.service.cache.*;
...
import com.yxp.chat.common.common.exception.GroupErrorEnum;
...
import com.yxp.chat.common.chat.domain.dto.RoomBaseInfo;
import com.yxp.chat.common.chat.domain.enums.GroupRoleAPPEnum;
...
import com.yxp.chat.common.chat.service.adapter.ChatAdapter;
...
public class RoomAppServiceImpl implements RoomAppService {
    ...
    public CursorPageBaseResp<ChatRoomResp> getContactPage(CursorPageBaseReq request, Long uid) {
        ...
        if (Objects.nonNull(uid)) {
            ...
            // 热门房间 从热点收信箱中查询在(start, end)之间的concat  精确时间聚合
