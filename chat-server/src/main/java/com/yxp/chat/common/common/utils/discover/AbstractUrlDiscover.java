package com.yxp.chat.common.common.utils.discover;

import cn.hutool.core.util.ReUtil;
import cn.hutool.core.util.StrUtil;
import com.yxp.chat.common.common.utils.discover.domain.UrlInfo;
import com.yxp.chat.common.common.utils.FutureUtils;
...
public abstract class AbstractUrlDiscover implements UrlDiscover {
    ...
    public Map<String, UrlInfo> getUrlContentMap(String content) {
        ...
        //并行请求List（CompletableFuture（pair（url， urlInfo）））
